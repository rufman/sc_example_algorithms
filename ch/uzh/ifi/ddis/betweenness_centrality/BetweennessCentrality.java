...
public class BetweennessCentrality {
	...
	public void executeGraph() {
		...
		graph.foreachVertex(FunUtil.convert(new VertexCommand() {
			public void f(Vertex v) {
				HashMap<Set<Integer>, Set<Integer>> v_state = (HashMap) v
						.state();
	...
	private class GetGlobalShortestPaths implements
		...
		public HashMap<Set<Integer>, PathValue> aggregate(
			...
			HashMap<Set<Integer>, PathValue> state0 = (HashMap<Set<Integer>, PathValue>) ((HashMap) arg0)
					.clone();
			HashMap<Set<Integer>, PathValue> state1 = (HashMap<Set<Integer>, PathValue>) ((HashMap) arg1)
					.clone();
